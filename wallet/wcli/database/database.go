...
func (d *database) GetAddress(address *common.Uint168) (*wutil.Addr, error) {
	d.lock.RLock()
...
func (d *database) GetAddrs() ([]*wutil.Addr, error) {
	d.lock.RLock()
	defer d.lock.RUnlock()
...
func (d *database) GetAddressUTXOs(address *common.Uint168) ([]*wutil.UTXO, error) {
	d.lock.RLock()
	defer d.lock.RUnlock()
...
func (d *database) GetAddressSTXOs(address *common.Uint168) ([]*wutil.STXO, error) {
	d.lock.RLock()
	defer d.lock.RUnlock()
